...
if __name__ == '__main__':
    fix_seed = 7 #1234 #2023 #2024 #2025 #2023
    ...
    parser.add_argument('--channel_independence', type=bool, default=0, help='whether to use channel_independence mechanism')
    ...
    parser.add_argument('--top_k', type=int, default=1, help='for LSTMblock')
